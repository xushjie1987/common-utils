 ...
 * href="http://commons.apache.org/proper/commons-lang/">Apache's Commons Lang</a> for a more
...
public abstract class StringUtils {
    ...
    public static String trimWhitespace(String str) {
        ...
        while (sb.length() > 0 &&
               Character.isWhitespace(sb.charAt(0))) {
            sb.deleteCharAt(0);
        }
        while (sb.length() > 0 &&
    ...
    public static boolean endsWithIgnoreCase(String str,
        ...
        String lcStr = str.substring(str.length() -
                                     suffix.length())
                          .toLowerCase();
    ...
    public static boolean substringMatch(CharSequence str,
        ...
        for (int j = 0; j < substring.length(); j++) {
            int i = index +
                    j;
            if (i >= str.length() ||
                str.charAt(i) != substring.charAt(j)) {
                return false;
            }
        }
        return true;
    ...
    public static String replace(String inString,
        ...
        while (index >= 0) {
            ...
            pos = index +
                  patLen;
            index = inString.indexOf(oldPattern,
                                     pos);
        }
        sb.append(inString.substring(pos));
     ...
     * @return the capitalized {@code String}, or {@code null} if the supplied string is
     *         {@code null}
     */
     ...
     * @return the uncapitalized {@code String}, or {@code null} if the supplied string is
     *         {@code null}
     */
     ...
     * 
     * @param localeString
     *            the locale {@code String}, following {@code Locale's} {@code toString()} format
     *            ("en", "en_UK", etc); also accepts spaces as separators, as an alternative to
     *            underscores
    ...
    public static Locale parseLocaleString(String localeString) {
        String[] parts = tokenizeToStringArray(localeString,
                                               "_ ",
                                               false,
                                               false);
        String language = (parts.length > 0
                                           ? parts[0]
                                           : "");
        String country = (parts.length > 1
                                          ? parts[1]
                                          : "");
     ...
     *            the time zone {@code String}, following {@link TimeZone#getTimeZone(String)} but
     *            throwing {@link IllegalArgumentException} in case of an invalid time zone
     *            specification
     ...
     * @return the {@code String} array ({@code null} if the supplied {@code Collection} was
     *         {@code null})
     */
    ...
    public static String[] split(String toSplit,
        ...
        String beforeDelimiter = toSplit.substring(0,
                                                   offset);
    ...
    public static Properties splitArrayElementsIntoProperties(String[] array,
                                                              String delimiter) {
        return splitArrayElementsIntoProperties(array,
                                                delimiter,
                                                null);
    }
    ...
    public static Properties splitArrayElementsIntoProperties(String[] array,
        ...
        for (String element : array) {
            if (charsToDelete != null) {
                element = deleteAny(element,
                                    charsToDelete);
            }
            String[] splittedElement = split(element,
                                             delimiter);
     ...
     * <p>
     * The given {@code delimiters} string can consist of any number of delimiter characters. Each
     ...
     * @param delimiters
     *            the delimiter characters, assembled as a {@code String} (each of the characters is
    ...
    public static String[] delimitedListToStringArray(String str,
        ...
        if ("".equals(delimiter)) {
            for (int i = 0; i < str.length(); i++) {
                result.add(deleteAny(str.substring(i,
                                                   i + 1),
                                     charsToDelete));
            }
        } else {
            int pos = 0;
            int delPos;
            while ((delPos = str.indexOf(delimiter,
                                         pos)) != -1) {
