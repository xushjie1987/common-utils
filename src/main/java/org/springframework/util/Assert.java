...
public abstract class Assert {
     ...
     *                       &quot;The array must have non-null elements&quot;);
     * </pre>
     * 
     * @param array
     *            the array to check
     ...
     *            and which may be used to provide context. It should normally end in ":" or "." so
     *            that the generated message looks OK when appended to it.
     * @throws IllegalArgumentException
     *             if the object is not an instance of clazz
     * @see Class#isInstance
     */
    public static void isInstanceOf(Class<?> type,
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException((StringUtils.hasLength(message)
                                                                              ? message +
                                                                                " "
                                                                              : "") +
                                               "Object of class [" +
     ...
     * 
     * <pre class="code">
     * Assert.isAssignable(Number.class,
     *                     myClass);
     * </pre>
     * 
     * @param superType
