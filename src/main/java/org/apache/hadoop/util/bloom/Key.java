...
public class Key implements Comparable<Key> {
     ...
     * <p>
     * <b>Invariant</b>: if it is not specified, each instance of <code>Key</code> will have a
    ...
    public int compareTo(Key other) {
        ...
        if (result == 0) {
            result = Double.valueOf(this.weight -
                                    other.weight)
                           .intValue();
        }
        return result;
