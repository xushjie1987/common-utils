 ...
 * <p>
 * It allows the removal of selected false positives at the cost of introducing random false
 * negatives, and with the benefit of eliminating some random false positives at the same time.
 * <p>
...
public final class RetouchedBloomFilter extends BloomFilter implements RemoveScheme {
     ...
     * 
     * @param k
     *            The false positive key to remove from <i>this</i> retouched Bloom filter.
     * @param scheme
