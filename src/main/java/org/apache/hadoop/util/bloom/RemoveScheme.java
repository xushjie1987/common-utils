...
public interface RemoveScheme {
     ...
     * MinimumFN Selection.
     * <p>
     * The idea is to select the bit to reset that will generate the minimum number of false
     * negative.
     */
     ...
     * Ratio Selection.
     * <p>
     * The idea is to select the bit to reset that will, at the same time, remove the maximum number
     * of false positve while minimizing the amount of false negative generated.
     */
