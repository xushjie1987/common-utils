...
public final class QuickSort implements IndexedSorter {
    ...
    private static void fix(IndexedSortable s,
                            int p,
                            int r) {
        if (s.compare(p,
                      r) > 0) {
    ...
    protected static int getMaxDepth(int x) {
        if (x <= 0)
            throw new IllegalArgumentException("Undefined for " +
                                               x);
    ...
    @Override
    public void sort(final IndexedSortable s,
                     int p,
                     int r,
    ...
    private static void sortInternal(final IndexedSortable s,
                                     int p,
                                     int r,
                                     final Progressable rep,
                                     int depth) {
